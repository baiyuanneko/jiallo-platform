...
@Data
@TableName("agentic_chat_message")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class AgenticChatMessage extends CommonEntity<AgenticChatMessage> implements Serializable {

    @Serial
    private static final long serialVersionUID = 1767457939558307058L;
